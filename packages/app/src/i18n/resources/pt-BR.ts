...
export const ptBR: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      imageDiff: {
        loading: "Carregando comparação de imagens",
        old: "Anterior",
        new: "Nova",
        twoUp: "Lado a lado",
        swipe: "Deslizar",
        onionSkin: "Sobreposição",
        xray: "Raio X",
        swipePosition: "Posição do deslizador",
        onionOpacity: "Opacidade da sobreposição",
        openImagePreview: "Abrir prévia da imagem {{title}}",
        heightDefault: "Padrão",
        heightLarge: "Grande",
        noPreviousImage: "Não há imagem anterior",
        imageDeleted: "Imagem excluída",
        dimensionsChanged:
          "Dimensões alteradas: {{oldWidth}} x {{oldHeight}} -> {{newWidth}} x {{newHeight}}",
        tooLarge: "A imagem é grande demais para visualizar",
        unsupported: "Prévia da imagem indisponível",
        readError: "Não foi possível carregar a imagem",
        invalid: "Dados de imagem inválidos",
        updateHost: "Atualize o host para visualizar diferenças de imagens",
      },
      openInEditor: {
        open: "Abrir",
