...
export const ar: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      imageDiff: {
        loading: "جارٍ تحميل مقارنة الصور",
        old: "القديمة",
        new: "الجديدة",
        twoUp: "جنبًا إلى جنب",
        swipe: "سحب",
        onionSkin: "تراكب",
        xray: "أشعة سينية",
        swipePosition: "موضع السحب",
        onionOpacity: "شفافية التراكب",
        openImagePreview: "فتح معاينة صورة {{title}}",
        heightDefault: "افتراضي",
        heightLarge: "كبير",
        noPreviousImage: "لا توجد صورة سابقة",
        imageDeleted: "تم حذف الصورة",
        dimensionsChanged:
          "تغيّرت الأبعاد: {{oldWidth}} x {{oldHeight}} -> {{newWidth}} x {{newHeight}}",
        tooLarge: "الصورة كبيرة جدًا للمعاينة",
        unsupported: "معاينة الصورة غير متاحة",
        readError: "تعذّر تحميل الصورة",
        invalid: "بيانات الصورة غير صالحة",
        updateHost: "حدّث المضيف لمعاينة اختلافات الصور",
      },
      openInEditor: {
        open: "يفتح",
