...
export const es: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      imageDiff: {
        loading: "Cargando comparación de imágenes",
        old: "Anterior",
        new: "Nueva",
        twoUp: "Lado a lado",
        swipe: "Deslizar",
        onionSkin: "Superposición",
        xray: "Rayos X",
        swipePosition: "Posición del deslizador",
        onionOpacity: "Opacidad de la superposición",
        openImagePreview: "Abrir vista previa de la imagen {{title}}",
        heightDefault: "Predeterminada",
        heightLarge: "Grande",
        noPreviousImage: "No hay imagen anterior",
        imageDeleted: "Imagen eliminada",
        dimensionsChanged:
          "Dimensiones cambiadas: {{oldWidth}} x {{oldHeight}} -> {{newWidth}} x {{newHeight}}",
        tooLarge: "La imagen es demasiado grande para previsualizarla",
        unsupported: "Vista previa de la imagen no disponible",
        readError: "No se pudo cargar la imagen",
        invalid: "Datos de imagen no válidos",
        updateHost: "Actualiza el host para previsualizar diferencias de imágenes",
      },
      openInEditor: {
        open: "Abierto",
