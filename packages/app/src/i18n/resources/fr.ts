...
export const fr: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      imageDiff: {
        loading: "Chargement de la comparaison d’images",
        old: "Ancienne",
        new: "Nouvelle",
        twoUp: "Côte à côte",
        swipe: "Balayage",
        onionSkin: "Superposition",
        xray: "Rayons X",
        swipePosition: "Position du balayage",
        onionOpacity: "Opacité de la superposition",
        openImagePreview: "Ouvrir l’aperçu de l’image {{title}}",
        heightDefault: "Par défaut",
        heightLarge: "Grande",
        noPreviousImage: "Aucune image précédente",
        imageDeleted: "Image supprimée",
        dimensionsChanged:
          "Dimensions modifiées : {{oldWidth}} x {{oldHeight}} -> {{newWidth}} x {{newHeight}}",
        tooLarge: "L’image est trop grande pour être prévisualisée",
        unsupported: "Aperçu de l’image indisponible",
        readError: "Impossible de charger l’image",
        invalid: "Données d’image non valides",
        updateHost: "Mettez à jour l’hôte pour prévisualiser les différences d’images",
      },
      openInEditor: {
        open: "Ouvrir",
